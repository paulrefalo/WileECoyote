...
//  WileECoyote
//
//  Created by Paul ReFalo on 7/27/17.
...
class UIButtonX: UIButton {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if popIn {
            ...
            UIView.animate(withDuration: 0.5, delay: popInDelay, usingSpringWithDamping: 0.6, initialSpringVelocity: 0, options: .allowUserInteraction, animations: {
